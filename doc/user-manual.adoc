...
```xml
    <smb:config name="SMB_Connector_Config" doc:name="SMB Connector Config" doc:id="d6b5ce20-7876-4bc5-8ad5-b0b8931590f1" >
		<smb:connection domain="${domain}" host="${host}" share="${share}" username="${username}" password="${password}" connectionTimeout="${timeout}" fileAge="${fileage}" fileAgeUnit="MILLISECONDS" connectionTimeoutUnit="MILLISECONDS" socketTimeout="30000" socketTimeoutUnit="MILLISECONDS"/>
	</smb:config>
```
